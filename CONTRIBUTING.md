...
> This is the canonical contributing guide. (The root `CONTRIBUTORS.md` points
> here.) For the design rationale behind the code, see
> [ARCHITECTURE.md](ARCHITECTURE.md); for the player-facing tour, see
> [README.md](README.md).
...
participating you agree to make it a welcoming, sensory-safe space.
